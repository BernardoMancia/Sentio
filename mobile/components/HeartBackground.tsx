...
export default function HeartBackground({ pulse }: HeartBackgroundProps) {
      ...
      >
        <Defs>
          <RadialGradient id="heartFill" cx="50%" cy="35%" r="65%">
            ...
            <Stop offset="75%" stopColor="#4c1d95" stopOpacity="0.08" />
        ...
        <Path
          d="M256 448 C 256 448 44 296 44 172 C 44 94 110 44 178 44 C 220 44 250 70 256 96 C 262 70 292 44 334 44 C 402 44 468 94 468 172 C 468 296 256 448 256 448 Z"
          fill="url(#heartFill)"
